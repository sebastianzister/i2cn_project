...
const double tau_m = 0.02;
    ...
    double* __restrict  _ptr_array_neurongroup_10_a = _array_neurongroup_10_a;
    double* __restrict  _ptr_array_neurongroup_10_d = _array_neurongroup_10_d;
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double* __restrict  _ptr_array_neurongroup_10_lastspike = _array_neurongroup_10_lastspike;
    char* __restrict  _ptr_array_neurongroup_10_not_refractory = _array_neurongroup_10_not_refractory;
    double* __restrict  _ptr_array_neurongroup_10_phi = _array_neurongroup_10_phi;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double d = _ptr_array_neurongroup_10_d[_idx];
        const double lastspike = _ptr_array_neurongroup_10_lastspike[_idx];
        char not_refractory = _ptr_array_neurongroup_10_not_refractory[_idx];
        double phi = _ptr_array_neurongroup_10_phi[_idx];
        ...
        _ptr_array_neurongroup_10_d[_idx] = d;
        _ptr_array_neurongroup_10_not_refractory[_idx] = not_refractory;
        _ptr_array_neurongroup_10_phi[_idx] = phi;
