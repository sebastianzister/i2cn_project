...
const double tau_m = 0.02;
    ...
    double* __restrict  _ptr_array_neurongroup_2_a = _array_neurongroup_2_a;
    double* __restrict  _ptr_array_neurongroup_2_d = _array_neurongroup_2_d;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double a = _ptr_array_neurongroup_2_a[_idx];
        double d = _ptr_array_neurongroup_2_d[_idx];
        ...
        double phi = _ptr_array_neurongroup_2_phi[_idx];
        ...
        _ptr_array_neurongroup_2_a[_idx] = a;
        _ptr_array_neurongroup_2_d[_idx] = d;
        _ptr_array_neurongroup_2_not_refractory[_idx] = not_refractory;
        _ptr_array_neurongroup_2_phi[_idx] = phi;
