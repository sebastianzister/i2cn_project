...
void _run_neurongroup_9_spike_resetter_codeobject()
{
...
const size_t _numnot_refractory = 100;
	...
	const int32_t *_events = _ptr_array_neurongroup_9__spikespace;
	const int32_t _num_events = _ptr_array_neurongroup_9__spikespace[N];
