...
const double tau_m = 0.02;
    ...
    double* __restrict  _ptr_array_neurongroup_a = _array_neurongroup_a;
    double* __restrict  _ptr_array_neurongroup_d = _array_neurongroup_d;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double a = _ptr_array_neurongroup_a[_idx];
        double d = _ptr_array_neurongroup_d[_idx];
        ...
        double phi = _ptr_array_neurongroup_phi[_idx];
        ...
        _ptr_array_neurongroup_a[_idx] = a;
        _ptr_array_neurongroup_d[_idx] = d;
        _ptr_array_neurongroup_not_refractory[_idx] = not_refractory;
        _ptr_array_neurongroup_phi[_idx] = phi;
