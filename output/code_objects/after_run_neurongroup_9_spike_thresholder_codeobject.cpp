...
void _after_run_neurongroup_9_spike_thresholder_codeobject()
{
...
_ptr_array_neurongroup_9__spikespace[N] = 0;  // Note that this is not an off-by-1-error: the array has N+1 elements
