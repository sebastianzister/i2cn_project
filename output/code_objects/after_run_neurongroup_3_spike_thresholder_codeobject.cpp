...
void _after_run_neurongroup_3_spike_thresholder_codeobject()
{
...
_ptr_array_neurongroup_3__spikespace[N] = 0;  // Note that this is not an off-by-1-error: the array has N+1 elements
