...
const size_t _numdelay = _dynamic_array_synapses_3_delay.size();
    ...
    double*   _ptr_array_synapses_3_delay = _array_synapses_3_delay;
    ...
    
    {
        ...
        synapses_3_pre.push(_ptr_array_neurongroup_1__spikespace, _ptr_array_neurongroup_1__spikespace[_num_spikespace-1]);
    }
