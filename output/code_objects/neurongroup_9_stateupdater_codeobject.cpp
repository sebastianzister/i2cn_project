...
const double tau_m = 0.02;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double V = _ptr_array_neurongroup_9_V[_idx];
        const double lastspike = _ptr_array_neurongroup_9_lastspike[_idx];
        char not_refractory = _ptr_array_neurongroup_9_not_refractory[_idx];
        ...
        if(not_refractory)
            V = _V;
        _ptr_array_neurongroup_9_V[_idx] = V;
        _ptr_array_neurongroup_9_not_refractory[_idx] = not_refractory;
