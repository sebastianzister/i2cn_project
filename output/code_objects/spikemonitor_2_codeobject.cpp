...
const size_t _num_source_idx = 100;
    ...
    int32_t* __restrict  _ptr_array_neurongroup_3_i = _array_neurongroup_3_i;
    ...
    int32_t _num_events = _ptr_array_neurongroup_3__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_neurongroup_3__spikespace[_j];
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                const int32_t _source_i = _ptr_array_neurongroup_3_i[_idx];
                ...
                _ptr_array_spikemonitor_2_count[_idx-_source_start]++;
            }
